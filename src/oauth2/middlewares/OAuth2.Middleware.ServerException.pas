unit OAuth2.Middleware.ServerException;
...
type
  ...
  TOAuth2MiddlewareServerException = class
  private
...
{ TOAuthServerException }

class procedure TOAuth2MiddlewareServerException.Invoke(AReq: THorseRequest; ARes: THorseResponse; ANext: TNextProc);
var
